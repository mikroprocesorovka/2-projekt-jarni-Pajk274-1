 ...
 619                     ; 321  }
 622  0012 80            	iret
 645                     ; 332  INTERRUPT_HANDLER(UART1_TX_IRQHandler, 17)
 645                     ; 333  {
 646                     	switch	.text
 647  0013               f_UART1_TX_IRQHandler:
 651                     ; 337  }
 654  0013 80            	iret
 676                     ; 388 INTERRUPT_HANDLER(I2C_IRQHandler, 19)
 676                     ; 389 {
 677                     	switch	.text
 678  0014               f_I2C_IRQHandler:
 682                     ; 393 }
 685  0014 80            	iret
 708                     ; 427  INTERRUPT_HANDLER(UART3_TX_IRQHandler, 20)
 708                     ; 428  {
 709                     	switch	.text
 710  0015               f_UART3_TX_IRQHandler:
 714                     ; 432  }
 717  0015 80            	iret
 740                     ; 439  INTERRUPT_HANDLER(UART3_RX_IRQHandler, 21)
 740                     ; 440  {
 741                     	switch	.text
 742  0016               f_UART3_RX_IRQHandler:
 746                     ; 444  }
 749  0016 80            	iret
 771                     ; 453  INTERRUPT_HANDLER(ADC2_IRQHandler, 22)
 771                     ; 454  {
 772                     	switch	.text
 773  0017               f_ADC2_IRQHandler:
 777                     ; 458  }
 780  0017 80            	iret
 803                     ; 506 INTERRUPT_HANDLER(EEPROM_EEC_IRQHandler, 24)
 803                     ; 507 {
 804                     	switch	.text
